...
def crawl_music():
    ...
    tables = soup.select('#app > main > div.bqkK3hvK > div.bXKSnKo9 > article > div.mhBuBvnc > div > div:nth-child(2) > div > div > div:nth-child(9)')
    woman = soup.select('#app > main > div.bqkK3hvK > div.bXKSnKo9 > article > div.mhBuBvnc > div > div:nth-child(2) > div > div > div:nth-child(11)')
